...
public class GeneralConfigurationGenerator {
    ...
    public GeneralConfigurationGenerator(Randomly r, MainOptions options) {
        this.r = r;
        this.isSingleThreaded = options.getNumberConcurrentThreads() == 1;
    }

    public static SQLQueryAdapter set(GlobalState globalState) {
        return new GeneralConfigurationGenerator(globalState.getRandomly(), globalState.getOptions()).get();
    }
