...
public class MySQLConfigurationGenerator extends BaseConfigurationGenerator{


    private static volatile MySQLConfigurationGenerator INSTANCE;
    private MySQLConfigurationGenerator(Randomly r, MainOptions options) {
        super(r, options);
    }
    ...
    public ConfigurationAction[] getAllActions() {
        return MySQLConfigurationGenerator.Action.values();
    }

    @Override
    protected SQLQueryAdapter generateConfigForAction(Object action) {
        MySQLConfigurationGenerator.Action mysqlAction = (MySQLConfigurationGenerator.Action) action;
        // 重用原有的生成逻辑
    ...
    protected String getActionName(Object action) {
        return ((MySQLConfigurationGenerator.Action) action).name();
    }

    public static SQLQueryAdapter set(GlobalState globalState) {
        return new MySQLConfigurationGenerator(globalState.getRandomly(), globalState.getOptions()).get();
    }
    /*
    ...
    private enum Action implements ConfigurationAction{
         ...
         */
        SORT_BUFFER_SIZE("sort_buffer_size", (r) -> r.getLong(32768, Long.MAX_VALUE), Scope.GLOBAL, Scope.SESSION), //
        ...
        INDEX_MERGE("optimizer_switch='index_merge", (r) -> Randomly.fromOptions("OFF", "ON"), Scope.GLOBAL, Scope.SESSION),
        INDEX_MERGE_UNION("optimizer_switch='index_merge_union", (r) -> Randomly.fromOptions("OFF", "ON"), Scope.GLOBAL, Scope.SESSION),
        INDEX_MERGE_SORT_UNION("optimizer_switch='index_merge_sort_union", (r) -> Randomly.fromOptions("OFF", "ON"), Scope.GLOBAL, Scope.SESSION),
        INDEX_MERGE_INTERSECTION("optimizer_switch='index_merge_intersection", (r) -> Randomly.fromOptions("OFF", "ON"), Scope.GLOBAL, Scope.SESSION),
        ENGINE_CONDITION_PUSHDOWN("optimizer_switch='engine_condition_pushdown", (r) -> Randomly.fromOptions("OFF", "ON"), Scope.GLOBAL, Scope.SESSION),
        INDEX_CONDITION_PUSHDOWN("optimizer_switch='index_condition_pushdown'", (r) -> Randomly.fromOptions("OFF", "ON"), Scope.GLOBAL, Scope.SESSION),
        MRR("optimizer_switch='mrr", (r) -> Randomly.fromOptions("OFF", "ON"), Scope.GLOBAL, Scope.SESSION),
        MRR_COST_BASED("optimizer_switch='mrr_cost_based", (r) -> Randomly.fromOptions("OFF", "ON"), Scope.GLOBAL, Scope.SESSION),
        BLOCK_NESTED_LOOP("optimizer_switch='block_nested_loop", (r) -> Randomly.fromOptions("OFF", "ON"), Scope.GLOBAL, Scope.SESSION),
        BATCHED_KEY_ACCESS("optimizer_switch='batched_key_access", (r) -> Randomly.fromOptions("OFF", "ON"), Scope.GLOBAL, Scope.SESSION),
        MATERIALIZATION("optimizer_switch='materialization", (r) -> Randomly.fromOptions("OFF", "ON"), Scope.GLOBAL, Scope.SESSION),
        SEMIJOIN("optimizer_switch='semijoin", (r) -> Randomly.fromOptions("OFF", "ON"), Scope.GLOBAL, Scope.SESSION),
        LOOSESCAN("optimizer_switch='loosescan", (r) -> Randomly.fromOptions("OFF", "ON"), Scope.GLOBAL, Scope.SESSION),
        FIRSTMATCH("optimizer_switch='firstmatch", (r) -> Randomly.fromOptions("OFF", "ON"), Scope.GLOBAL, Scope.SESSION),
        DUPLICATEWEEDOUT("optimizer_switch='duplicateweedout", (r) -> Randomly.fromOptions("OFF", "ON"), Scope.GLOBAL, Scope.SESSION),
        SUBQUERY_MATERIALIZATION_COST_BASED("optimizer_switch='subquery_materialization_cost_based", (r) -> Randomly.fromOptions("OFF", "ON"), Scope.GLOBAL, Scope.SESSION),
        USE_INDEX_EXTENSIONS("optimizer_switch='use_index_extensions", (r) -> Randomly.fromOptions("OFF", "ON"), Scope.GLOBAL, Scope.SESSION),
        CONDITION_FANOUT_FILTER("optimizer_switch='condition_fanout_filter", (r) -> Randomly.fromOptions("OFF", "ON"), Scope.GLOBAL, Scope.SESSION),
        DERIVED_MERGE("optimizer_switch='derived_merge", (r) -> Randomly.fromOptions("OFF", "ON"), Scope.GLOBAL, Scope.SESSION),
        USE_INVISIBLE_INDEXES("optimizer_switch='use_invisible_indexes", (r) -> Randomly.fromOptions("OFF", "ON"), Scope.GLOBAL, Scope.SESSION),
        SKIP_SCAN("optimizer_switch='skip_scan", (r) -> Randomly.fromOptions("OFF", "ON"), Scope.GLOBAL, Scope.SESSION),
        HASH_JOIN("optimizer_switch='hash_join", (r) -> Randomly.fromOptions("OFF", "ON"), Scope.GLOBAL, Scope.SESSION),
        SUBQUERY_TO_DERIVED("optimizer_switch='subquery_to_derived", (r) -> Randomly.fromOptions("OFF", "ON"), Scope.GLOBAL, Scope.SESSION),
        PREFER_ORDERING_INDEX("optimizer_switch='prefer_ordering_index", (r) -> Randomly.fromOptions("OFF", "ON"), Scope.GLOBAL, Scope.SESSION),
        DERIVED_CONDITION_PUSHDOWN("optimizer_switch='derived_condition_pushdown", (r) -> Randomly.fromOptions("OFF", "ON"), Scope.GLOBAL, Scope.SESSION);
...
//        }
    ...
    public static BaseConfigurationGenerator getInstance(Randomly r, MainOptions options) {
        if (INSTANCE == null) {
            synchronized (MySQLConfigurationGenerator.class) {
                if (INSTANCE == null) {
                    INSTANCE = new MySQLConfigurationGenerator(r, options);
                }
            }
        }
        return INSTANCE;
    ...
    public static List<SQLQueryAdapter> getAllOptimizer(GlobalState globalState) {
